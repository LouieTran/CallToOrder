<?php
namespace Magenest\CallToOrder\Controller\Product;
 ...
 * Class Save
 *
 * @package Magenest\CallToOrder\Controller\Product
 */
...
//            ->debug(print_r($data, true));
        ...
        if($data){
            $array = [
                ...
                'time_to_call'  => 'from '.$data['time1'].'h to '.$data['time2'].'h',

            ];
            $model = $this->_objectManager->create('Magenest\CallToOrder\Model\Manager')
